        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #1f3c88">
                ...
                <div class="card-group">
                  ...
                  <div class="col-sm-4" style="padding: 6px; margin-left: 70px">
                      <div class="card">
                          <a href="presidenciales.php"><img src="http://aytomengibar.com/wp-content/uploads/2019/04/generica-votaciones-votar-elecciones-democracia-745x450.jpg"
                              class="card-img-top" alt="..."></a>
                          <div class="card-body">
                              <h5 class="card-title fuente_cuerpo">Votaciones Presidenciales</h5>
                              <a href="presidenciales.php" class="card-link">Votar</a>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-sm-4" style="padding: 6px; margin-left: 200px">
                      <div class="card">
                          <a href="municipales.php"><img src="https://elindependienteiguazu.com/wp-content/uploads/2019/01/elecciones-2019.jpg" class="card-img-top"
                              alt="..."></a>
                          <div class="card-body">
                              <h5 class="card-title fuente_cuerpo">Votaciones Municipales</h5>
                              <a href="municipales.php" class="card-link">Votar</a>
                          </div>
                      </div>
                  </div>
