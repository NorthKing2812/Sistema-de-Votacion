...
ALTER TABLE `candidaturas`
  ADD UNIQUE KEY `id_candidato` (`id_candidato`),
...
--
-- Indexes for table `votante`
--
ALTER TABLE `votante`
  ADD PRIMARY KEY (`id_votante`);

--
-- Indexes for table `votante_voto`
--
...
--
ALTER TABLE `candidaturas`
  ADD CONSTRAINT `candidaturas_ibfk_1` FOREIGN KEY (`id_candidato`) REFERENCES `candidato` (`id_candidato`) ON UPDATE CASCADE,
  ADD CONSTRAINT `candidaturas_ibfk_2` FOREIGN KEY (`id_municipio`) REFERENCES `municipio` (`id_municipio`) ON UPDATE CASCADE,
  ADD CONSTRAINT `candidaturas_ibfk_3` FOREIGN KEY (`id_provincia`) REFERENCES `provincia` (`id_provincia`) ON UPDATE CASCADE;
COMMIT;
